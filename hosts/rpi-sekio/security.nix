# hosts/rpi-sekio/security.nix
#
# Security configuration for rpi-sekio host with comprehensive hardening
{
  lib,
  pkgs,
  ...
...

{
  ...
  # Firewall configuration specific to rpi-sekio using the NFT-based firewall
