...

{
  ...
  security.pam.loginLimits = [
    { domain = "chrony"; item = "nice"; type = "-"; value = "-10"; }
    { domain = "chrony"; item = "rtprio"; type = "-"; value = "20"; }
    { domain = "gpsd"; item = "nice"; type = "-"; value = "-5"; }
  ];
  ...
  environment.systemPackages = with pkgs; [
    iotop htop lm_sensors smartmontools sysstat
    glances nmon procps iproute2
  ];
